	...
	if (agents.length === 0) {
		return (
			<div className="max-w-md mx-auto pt-12 text-center space-y-4">
				<div className="inline-flex w-14 h-14 rounded-2xl bg-amber-50 text-amber-600 items-center justify-center">
				...
				<Link
					to="/studio/skills"
					className="inline-flex items-center gap-1.5 px-4 py-2 text-sm rounded-lg bg-amber-500 text-white hover:bg-amber-600 transition-colors"
				>
