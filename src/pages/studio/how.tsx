				...
				{nodes.map((nd, i) => (
					<div key={nd.label} className="flex items-stretch gap-2 flex-1">
						<div className={cn(
							...
							nd.tone === 'emerald' && 'border-amber-200 bg-amber-50/50',
							...
							<div className={cn(
								...
								nd.tone === 'emerald' && 'bg-amber-100 text-amber-700',
		...
		<section className={cn(
			...
			<div className="px-4 pt-3.5 pb-3 flex items-start gap-3">
				<div className={cn(
					...
					tone === 'emerald' && 'bg-amber-100 text-amber-700',
	...
	return (
		<div className="space-y-2.5">
			<div className="flex items-center gap-3 text-[11px] text-slate-500">
				...
				<span className="inline-flex items-center gap-1"><Wand2 className="w-3.5 h-3.5 text-amber-500" />{ai} generated by AI</span>
			</div>
				...
				{assembly.map((p) => (
					<div key={p.name} className="rounded-lg border border-slate-200/70 bg-white px-3 py-2 flex items-start gap-2.5">
						<div className={cn(
							...
							p.source === 'ai' ? 'bg-amber-50 text-amber-600' : 'bg-slate-100 text-slate-500',
						)}>
		...
		<div className="space-y-3">
			...
			{intent.detail && (
				<Link
					...
					className="inline-flex items-center gap-1 text-[12px] text-amber-700 hover:text-amber-800 hover:underline"
				>
