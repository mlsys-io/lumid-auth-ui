...
export default function CycleInspector() {
	...
	return (
		<div className="space-y-4">
			<Link to="/studio/today" className="inline-flex items-center text-sm text-slate-600 hover:text-slate-900 gap-1">
			...
			<div className="rounded-lg border border-slate-200 bg-white p-4">
				<h2 className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-2">Summary</h2>
						...
						return (
							<li key={s.step_id} className="rounded-lg border border-slate-200 bg-white overflow-hidden">
								...
								>
									...
									{s.stage && <span className="text-[10px] uppercase tracking-wide text-slate-400 ml-1">{s.stage}</span>}
								...
								{open && (
									<div className="px-3 pb-3 pl-12 space-y-3">
										...
										<div>
											<div className="text-[10px] uppercase tracking-wide text-slate-400 mb-1">Output</div>
