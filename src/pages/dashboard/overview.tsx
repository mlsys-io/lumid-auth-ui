		...
		<div className="space-y-6">
			...
			<section>
				...
				<div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
					...
					<AreaLink to="/studio/research-fleet"     icon={Server}    label="Research Fleet"   hint="Sites, nodes, workers, jobs and rented GPUs" />
...
function ClusterStat({ data }: { data: Cluster[] | null }) {
	if (data === null) return <ErrorTile icon={Layers} label="Clusters" to="/studio/research-fleet" />;
...
function NodeStat({ data }: { data: Node[] | null }) {
	if (data === null) return <ErrorTile icon={Server} label="Nodes" to="/studio/research-fleet" />;
...
function WorkerStat({ data }: { data: Worker[] | null }) {
	if (data === null) return <ErrorTile icon={Cpu} label="Workers" to="/studio/research-fleet" />;
