...
// fresh-user hero AND, permanently, above a returning user's apps — Stage 1
// ("given an intent, assemble a workflow") is a recurring action, so this
// surface always sticks.
//
// Extracted from pages/studio/intents.tsx so the launcher lives with its
// data (components/studio/starters.tsx) and pages can import it without
// dragging in a whole page module.
...
export function FreshUserHero({ name }: { name: string }) {
	return (
