		...
		<div className="space-y-1.5">
			<div className="flex flex-wrap items-center gap-1.5">
				<select
					...
					className="px-2 py-1 text-xs rounded-lg border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-amber-400/40"
				>
				...
				{needsTime && (
					<input
						...
						className="px-2 py-[3px] text-xs rounded-lg border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-amber-400/40"
					/>
				)}
				{preset === "weekly" && (
					<select
				...
				{preset === "custom" && (
					<input
						...
						className="w-36 px-2 py-1 text-xs font-mono rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-400/40"
					/>
				)}
			</div>
