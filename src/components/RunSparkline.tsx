...
const SQ_CLASS: Record<string, string> = {
	o: "bg-gold-400",
	r: "bg-gold-400",   // recovered: succeeded only via retry/fallback (self-healed)
	x: "bg-rose-500",
	_: "bg-slate-300",
				...
				return (
					<button
						...
						className={[
							...
							isPinned ? "w-2 h-4 scale-110 ring-2 ring-gold-600 ring-offset-1 ring-offset-white relative z-10"
