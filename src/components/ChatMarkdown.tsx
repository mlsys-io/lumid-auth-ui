...
const components: Components = {
	...
	// "quoting back" voice.
	blockquote: ({ children }) => (
		<blockquote className="my-2 first:mt-0 last:mb-0 pl-3 border-l-2 border-gold-300 text-slate-600 italic">
			{children}
		</blockquote>
	),
	...
	a: ({ href, children }) => {
		const h = String(href || "");
		const cls = "text-gold-700 underline decoration-gold-300 hover:decoration-gold-600 underline-offset-2 break-words";
