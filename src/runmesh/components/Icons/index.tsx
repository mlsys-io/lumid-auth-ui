...
export const Icons = {
  ...
  Tag: ({ className }: { className?: string }) => (
    <svg
      ...
      className={className}
    >
      <path d="M20.59 13.41 11 4.83a2 2 0 0 0-1.42-.59H5a2 2 0 0 0-2 2v4.59a2 2 0 0 0 .59 1.42l9.59 9.59a2 2 0 0 0 2.82 0l4.59-4.59a2 2 0 0 0 0-2.82Z"></path>
  ...
  Workflow: ({ className }: { className?: string }) => (
    ...
    >
      ...
      <line x1="14" y1="14" x2="14" y2="10"></line>
  ...
  XOctagon: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  Gitee: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
      ...
      className={className}
    >
      <path d="M12 .5C5.648.5.5 5.648.5 12S5.648 23.5 12 23.5 23.5 18.352 23.5 12 18.352.5 12 .5Zm5.43 12.582a4.938 4.938 0 0 1-4.937 4.936H9.09a.674.674 0 0 1-.673-.674v-.808a.674.674 0 0 1 .674-.674h3.403a2.79 2.79 0 0 0 2.79-2.79A2.79 2.79 0 0 0 12.494 10h-4.36a.674.674 0 0 1-.674-.674v-.808a.674.674 0 0 1 .674-.674h4.236a4.938 4.938 0 0 1 4.936 4.938Z" />
    </svg>
  ),
  ...
  Wechat: ({ className }: { className?: string }) => (
    <svg
      ...
      className={className}
    >
      <path d="M8.7 13.65c-.24 0-.46.02-.68.05-.2.6-.68 1.08-1.24 1.34-.35.16-.74.25-1.15.25-.97 0-1.83-.5-2.26-1.22-.16-.27-.25-.58-.25-.91 0-.96.78-1.74 1.74-1.74.45 0 .86.17 1.18.45.34.3.56.73.56 1.22 0 .21-.04.41-.12.59.39-.17.75-.45 1.02-.8.15-.2.27-.42.35-.66-.18-.54-.6-1.01-1.15-1.28-.42-.2-0.89-.31-1.39-.31-1.8 0-3.26 1.46-3.26 3.26 0 1.8 1.46 3.26 3.26 3.26.85 0 1.63-.33 2.22-.86.23-.21.43-.45.6-.71-.24.05-.48.07-.73.07zM16.9 7.45c-.29 0-.55.03-.8.08-.25.7-.82 1.28-1.5 1.58-.42.19-.88.29-1.36.29-1.13 0-2.14-.58-2.65-1.43-.19-.32-.3-.69-.3-1.08 0-1.13.92-2.05 2.05-2.05.53 0 1.01.2 1.39.53.4.35.66.86.66 1.43 0 .25-.05.49-.14.7.46-.2.88-.53 1.21-.94.18-.23.32-.49.42-.77-.21-.63-.71-1.19-1.36-1.51-.49-.24-1.05-.37-1.64-.37-2.12 0-3.84 1.72-3.84 3.84 0 2.12 1.72 3.84 3.84 3.84 1.01 0 1.93-.39 2.61-1.02.27-.25.51-.53.71-.84-.28.05-.57.08-.86.08zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8z" />
    </svg>
  ),
  ...
  CornerUpLeft: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  CornerUpRight: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  DownloadCloud: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  Sheets: ({ className }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  Slack: ({ className }: { className?: string }) => (
    ...
    >
      ...
      <rect width="3" height="3" x="8" y="19" rx="1.5" />
      <path d="M5 15.5V14H3.5A1.5 1.5 0 1 0 5 15.5" />
      <rect width="3" height="3" x="19" y="13" rx="1.5" />
      <path d="M15.5 19H14v1.5a1.5 1.5 0 1 0 1.5-1.5" />
      <rect width="3" height="3" x="2" y="8" rx="1.5" />
